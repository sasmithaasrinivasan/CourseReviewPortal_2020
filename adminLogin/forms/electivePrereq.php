...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="elecpre">
      <h2>Elective Pre-Reqs</h2>
      <form class="pre_values" action="index.html" method="post">

        <div class="inputElecPre">
        ...
        <div class="inputElecPre">
          ...
          <label for="ElecPre_id">Pre-Requisite ID</label>
        </div>

        <div class="inputElecPre">
          <input type="text" name="" required="" id="ElecFacName"/>
          <label for="ElecPreName">Elective ID</label>
        </div>
