...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="elecadmin">
      <h2>Administrator</h2>
      <form class="admin_values" action="index.html" method="post">

        <div class="inputElecAdmin">
        ...
        <div class="inputElecAdmin">
          ...
          <label for="ElecAdmin_id">Admin ID</label>
        </div>
        ...
        <div class="inputElecAdmin">
          <input type="text" name="" required=""  />
          <label for="ElecAdmin_Email">Email ID</label>
        </div>


        <div class="inputElecAdmin">
          <input type="text" name="" required=""  />
          <label for="ElecAdminPwd">Password</label>
        </div>
