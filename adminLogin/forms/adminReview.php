...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="elecreview">
      <h2>Review</h2>
      <form class="review_values" action="index.html" method="post">

        <div class="inputElecReview">
        ...
        <div class="inputElecReview">
          ...
          <label for="ElecAlum_id">Alumni ID</label>
        </div>
        ...
        <div class="inputElecReview">
          <input type="text" name="" required=""  />
          <label for="ElecElective_id">Elective ID</label>
        </div>


        <div class="inputElecReview">
          <input type="text" name="" required=""  />
          <label for="ElecReviewData">Review Data</label>
        </div>
