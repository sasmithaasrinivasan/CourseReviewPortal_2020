...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="elec">
      <h2>Electives</h2>
      <form class="elec_values" action="index.html" method="post">
        ...
        <div class="inputElec">
          ...
          <label for="Elec_id">Elective ID</label>
        </div>

        <div class="inputElec">
          <input type="text" name="" required="" id="ElecName"/>
          <label for="ElecName">Name</label>
        </div>

        <div class="inputElec">
          <input type="text" name="" required="" id="ElecEmail"/>
          <label for="ElecCredits">Credits</label>
        </div>

        <div class="inputElec">
          <input type="text" name="" required="" id="ElecEmail"/>
          <label for="ElecSem">Semester</label>
        </div>

        <div class="inputElec">
          <input type="text" name="" required="" id="ElecEmail"/>
          <label for="ElecCO">Course Objectives</label>
        </div>

        <div class="inputElec">
          <input type="text" name="" required="" id="ElecDept"/>
          <label for="ElecDept">Department</label>
        </div>

        <div class="inputElec">
          <input type="text" name="" required="" id="ElecDeg"/>
          <label for="ElecDeg">Degree</label>
        </div>
