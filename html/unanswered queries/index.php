...
<div class="container">
  ...
  <aside>
   ...
   <main>
	...
	<div class="">
	<form action ="<?php echo htmlspecialchars('fo.php');?>" method="POST">
		...
		<select name="state" id="state" class="jk"><option val="">------- Select --------</option></select>
    <input type="submit" name="submit" class="jk"> </form>
