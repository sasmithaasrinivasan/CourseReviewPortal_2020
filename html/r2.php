...
<html>
 ...
 <div class="container">
  ...
  <div class="dropdown-content" >
    <a href="ans.php" style="color: #000;">Answered</a>
    <a href="unans.php" style="color: #000;">Unanswered</a>
   </div>
 </div>
<?php
	     $sql="Select Student_id,Elective_id,Question,Answer,Faculty_id from forums where Student_id='CB.EN.U4CSE18455';  ";
